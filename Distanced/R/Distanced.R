...
#' @useDynLib Distanced
#' @export
Distanced = function(sample.filepath, reference.filepath, n_sample_max.scalar, replace_ambiguous_letters.character, random_seed.character){
#Load Sequence Files
...
#Define Helper Functions
  ...
  #'
  #' @param sample.filepath Path to file for sample sequences
  #' @return A binary (TRUE is fastq, FALSE is fasta)
  #' @export
